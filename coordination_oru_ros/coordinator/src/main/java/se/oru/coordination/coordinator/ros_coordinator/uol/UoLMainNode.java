package se.oru.coordination.coordinator.ros_coordinator.uol;
...
public class UoLMainNode extends AbstractNodeMain {
	/**
	 * This Node is based upon OrklaDemoMS3MainNode
	 * Its main difference is to enable RePlan service, intended to be used in human awareness
	 */
