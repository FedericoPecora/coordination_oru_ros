...
import se.oru.coordination.coordinator.ros_coordinator.generic.MainNode;

public class NCFMDemoMS4MainNode {
	...
	private void setupServices() {
		...
		node.newServiceServer("coordinator/abort", orunav_msgs.Abort._TYPE, new ServiceResponseBuilder<orunav_msgs.AbortRequest, orunav_msgs.AbortResponse>() {
			@Override
			public void build(orunav_msgs.AbortRequest arg0, orunav_msgs.AbortResponse arg1) throws ServiceException {
				System.out.println(MainNode.ANSI_RED + ">>>>>>>>>>>>>> ABORTING Robot" + arg0.getRobotID());
				System.out.println(MainNode.ANSI_RESET);
		...
		node.newServiceServer("coordinator/replan", orunav_msgs.RePlan._TYPE, new ServiceResponseBuilder<orunav_msgs.RePlanRequest, orunav_msgs.RePlanResponse>() {
			...
			public void build(orunav_msgs.RePlanRequest arg0, orunav_msgs.RePlanResponse arg1) throws ServiceException {
				System.out.println(MainNode.ANSI_RED + ">>>>>>>>>>>>>> REPLANNING Robot" + arg0.getRobotID());
				System.out.println(MainNode.ANSI_RESET);
	...
	private void callComputeTaskService(final IliadMission iliadMission) {
		...
		serviceClient.call(request, new ServiceResponseListener<ComputeTaskResponse>() {
			...
			public void onFailure(RemoteException arg0) {
				...
				taskComputingSucceed.put(iliadMission.getRobotID(), false);
				isTaskComputing.put(iliadMission.getRobotID(), false);
			}
			...
			public void onSuccess(ComputeTaskResponse arg0) {
				...
				taskComputingSucceed.put(arg0.getTask().getTarget().getRobotId(), true);
